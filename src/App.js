...
const initialState = {
  items: [
    { id: 1, title: "Yoga Class", description: "Have to take a yoga class today", status: false },
    { id: 2, title: "Yoga Class Thursday", description: "Have to take a yoga class Thursday", status: false }
  ]
};
